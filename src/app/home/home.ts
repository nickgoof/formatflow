...
export class Home {
  ...
  content = {
    de: {
      nav_btn: 'IT', // Text auf dem Button (zeigt zur anderen Sprache)
    ...
    it: {
      nav_btn: 'DE', // Text auf dem Button (um zurück zu wechseln)
  ...
  toggleLanguage() {
    this.currentLang = this.currentLang === 'de' ? 'it' : 'de';
  }
}
